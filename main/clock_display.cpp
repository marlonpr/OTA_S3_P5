...
void ota_test_clock_display_make_date_scroll_text(const ds3231_time_t *time,
                                                  char *buf,
                                                  size_t size)
{
    if (!time || !buf || size == 0) {
                               ...
                               hour_format_t format, int dB_value)
{
    ...
    static char date_scroll_text[128];

	ota_test_clock_display_make_date_scroll_text(time,
	                                    date_scroll_text,
